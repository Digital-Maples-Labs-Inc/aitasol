 ...
 * This script uses application default credentials (gcloud auth)
 */
  ...
  try {
    ...
    for (const page of pages) {
      ...
      if (!slugQuery.empty) {
        ...
        // Update if missing sections or other important fields
    ...
    if (error.code === 'auth/credential-error' || error.message.includes('credential')) {
