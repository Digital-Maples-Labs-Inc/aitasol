...
export default function Testimonials() {
  ...
  const testimonialsTitleSection = getSection('testimonials-title') || { id: 'testimonials-title', content: 'Testimonials', type: 'heading' as const };
  const testimonialsSubtitleSection = getSection('testimonials-subtitle') || { id: 'testimonials-subtitle', content: 'See what our customers love about our products. Discover how we excel in efficiency, durability, and satisfaction. Join us for quality, innovation, and reliable support.', type: 'paragraph' as const };
